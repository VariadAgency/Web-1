...
// Contact Wizard (frontend only)
    (function(){
        ...
        function toggleChip(btn){
            ...
            // --- Cookie Requirement Check: Ultra Strict ---
            if(!key && typeof klaro !== 'undefined') {
                const manager = klaro.getManager();
                // Prüfe, ob Facebook EXPLIZIT auf true steht
                const hasAcceptedFacebook = manager.consents && manager.consents.facebook === true;
                
                if (!hasAcceptedFacebook) {
                    console.log('[Wizard] Blocked: Facebook consent is not true. Current consents:', manager.consents);
